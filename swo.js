(function () {
    ...
    function startPlugin() {
        if (window.smotretk_plugin_loaded) return;
        window.smotretk_plugin_loaded = true;
        ...
        Lampa.Listener.follow('full', function(e) {
            if (e.type == 'complite') {
                var btn = $(
                    '<div class="full-start__button selector view--smotretk">' +
                ...
                btn.on('hover:enter', function() {
                    Lampa.Component.add('smotretk', component);
                    Lampa.Activity.push({
                        url: '',
                        title: 'SmotreТK',
                        component: 'smotretk',
        ...
        console.log('[SmotreТK] Plugin v9.7 loaded - KP Images Preferred');
    }
