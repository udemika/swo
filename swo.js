(function () {
    ...
    /**
     * Filmix Nexus (Series Pro Fix) v2.1.0
     * - Исправлена ошибка с render и pause (теперь они явно определены как функции)
     * - Приоритет серий: если серии есть — показываем сразу, даже с кнопками озвучек
     * - Меню озвучек только если серий нет
     * - Возврат к стабильной версии с минимальными изменениями
     */
        ...
        function FilmixComponent(object) {
            ...
            this.renderList = function() {
                ...
                raw_data.forEach(function(data) {
                    var title = data.title || (data.translate ? data.translate : 'Серия');
